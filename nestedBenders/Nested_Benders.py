...
# Parameters to compute upper and lower boundsv
...
for iter_ in m.iter:
    ...
    # Compute upper bound
    m.cost_forward[iter_] = sum(prob[n] * m.cost_stage[stage, n, iter_] for stage in m.stages for n in n_stage[stage])
